...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 🔴 NOTA: Antes de usar este script, debes pegar el código completo de la clase InteractiveSticker
    // en este archivo js/sticker-manager.js, justo encima de esta línea.
    checkAgeRestriction(); 
});
